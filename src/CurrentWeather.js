...
const CurrentWeather = ({ main, city, weather }) => {
  ...
  return (
    <section className="w-1/2 h-2/4 border bg-gray-50 rounded p-6 bg-white flex items-center justify-between flex-col text-xl shadow-md p-5 lg:flex-row lg:h-1/4">
